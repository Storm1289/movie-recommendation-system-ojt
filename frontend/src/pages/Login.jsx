            ...
            <div className="relative z-10 w-full max-w-md px-6">
                ...
                <div className="bg-surface-dark/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                    ...
                    <div className="w-full">
                        {googleConfigured ? (
                            <div className="relative flex min-h-[44px] w-full items-center justify-center overflow-hidden rounded-xl border border-slate-700 bg-bg-dark [&>div]:!w-full [&_iframe]:!mx-auto [&_iframe]:!w-full">
                                <GoogleLogin
                                ...
                                />
                                {googleBusy && (
                                    <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-bg-dark/80">
                                        <div className="animate-spin w-5 h-5 border-2 border-white border-t-transparent rounded-full" />
                                    </div>
                                )}
                            </div>
